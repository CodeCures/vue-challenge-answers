...
describe("useCounter", () => {
  let wrapper
  let incBtn: DOMWrapper<HTMLButtonElement>
  let decBtn: DOMWrapper<HTMLButtonElement> 
  let resetBtn: DOMWrapper<HTMLButtonElement>
  let text: DOMWrapper<HTMLParagraphElement>
